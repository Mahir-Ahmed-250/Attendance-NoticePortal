              ...
              <div className="bg-white rounded-3xl border border-slate-200/80 p-6 sm:p-8 shadow-md">
                <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 border-b border-slate-150 pb-5 mb-6">
                  <div className="text-left">
                    ...
                    <p className="text-xs text-slate-500 font-medium mt-1">
                      Manage campuses, search branches, and assign campus coordinators.
                    </p>
                  </div>
                  <button
                    type="button"
                ...
                {/* Branch & Campus Search Lookup Card */}
                            ...
                            <td className="p-4 text-xs">
                              <div className="flex items-center gap-2 flex-wrap">
                                ...
                                <button
                                  ...
                                  className="px-2.5 py-1 text-indigo-600 hover:bg-indigo-50 rounded-lg border border-indigo-200 text-xs font-bold transition-all cursor-pointer flex items-center gap-1 shrink-0"
                                >
                                  <Edit3 className="w-3 h-3" />
                                  Edit / Manage
                                </button>
...
function BranchManagementModal({
  ...
  const assignedUdvashUnmesh = assignedBranches.filter((b) =>
    b.name.toLowerCase().includes("unmesh")
  ).length;
  const assignedUdvash = assignedBranches.filter((b) =>
    !b.name.toLowerCase().includes("unmesh")
  ).length;
